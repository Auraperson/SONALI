...
def stream_markup_timer(_, videoid, chat_id, played, dur):
    ...
    buttons = [
      ...
      [
            InlineKeyboardButton(text="❍𝐎ᴡɴᴇʀ ❍", url="https://t.me/YukkiEmpire",),
            InlineKeyboardButton(text="❍𝐒ᴜᴘᴘᴏʀᴛ❍", url="https://t.me/HeavenChatGroup",),
        ],
        [
            InlineKeyboardButton(text=" 𝖠ᴅᴅ ᴍᴇ 𝖡ᴀʙʏ", url="https://t.me/SequelMusicBot?startgroup=true",),
        ],
        [
