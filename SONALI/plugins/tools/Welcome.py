...
❖𝐌ᴀᴅᴇ  𝐁ʏ [Yukki Empire](https://t.me/YukkiEmpire)
""",
            reply_markup=InlineKeyboardMarkup([[InlineKeyboardButton(f"𝐀ᴅᴅ 𝐌ᴇ 𝐁ᴀʙʏ", url=f"https://t.me/SequelMusicBot?startgroup=true")]])
        )
    except Exception as e:
        LOGGER.error(e)
    try:
