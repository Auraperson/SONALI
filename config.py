...
# -------------------------------------------------------
OWNER_USERNAME = getenv("OWNER_USERNAME","SecutrYukki")
# --------------------------------------------------------
BOT_USERNAME = getenv("BOT_USERNAME","SequelMusicBot")
# --------------------------------------------------------
...
UPSTREAM_REPO = getenv(
    "UPSTREAM_REPO",
    "https://github.com/Auraperson/sonali",
)
...
SUPPORT_CHANNEL = getenv("SUPPORT_CHANNEL", "https://t.me/YukkiEmpire")
